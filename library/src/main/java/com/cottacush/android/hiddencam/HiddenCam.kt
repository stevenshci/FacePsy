...
class HiddenCam @JvmOverloads constructor(
     ...
     */
    private fun capture() {
        imageCapture.takePicture(createFile(baseFileDirectory, triggerName), MainThreadExecutor,
            object : ImageCapture.OnImageSavedListener {
                ...
                override fun onImageSaved(file: File) = imageCapturedListener.onImageCaptured(file, triggerName, metadata)
            })
    }
}
